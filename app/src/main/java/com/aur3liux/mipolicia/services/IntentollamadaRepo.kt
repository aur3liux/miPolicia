...
class IntentollamadaRepo @Inject constructor() {
    //-- INICIO DE SESION
    fun doRegistroIntentoLlamada(context: Context, jsonObj: JSONObject): MutableLiveData<RequestResponse> {
        val _userData: MutableLiveData<RequestResponse> = MutableLiveData<RequestResponse>()
        val url = "${Store.API_URL.BASE_URL}/api/call/911"
